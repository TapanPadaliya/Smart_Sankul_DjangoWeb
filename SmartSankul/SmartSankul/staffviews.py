...
from app.models import Staff,Staff_Notification,Staff_leave,Staff_Feedback,Session_Year,Subject,Student,Attendance,Attendance_Report
...
def STAFF_APPLY_LEAVE_SAVE(request):
    if request.method == "POST":
        ...
        leave.save()
        messages.success(request,'Leave Send succcessfully')
